...
bottom-right corner in increments of one table row, so the two columns stay on
a shared vertical grid; every threshold shown is measured for this hardware
rather than guessed.
